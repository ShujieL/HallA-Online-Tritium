...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriFadcRasteredBeam*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriFadcRaster*)0x0)->GetClass(); }
   return fgIsA;
}
...
"/home/shujie/analyzer/tritium-official/replay/libraries/TriFadcRasteredBeam",
"/u/apps/root/6.12.06/root/include",
"/home/shujie/analyzer/tritium-official/replay/libraries/TriFadcRasteredBeam/",
0
    };
