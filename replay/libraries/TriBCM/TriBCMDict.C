...
namespace ROOT {
   static void *new_TriBCM(void *p = 0);
   static void *newArray_TriBCM(Long_t size, void *p);
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TriBCM*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TriBCM", ::TriBCM::Class_Version(), "TriBCM.h", 20,
                  ...
                  sizeof(::TriBCM) );
      instance.SetNew(&new_TriBCM);
      instance.SetNewArray(&newArray_TriBCM);
...
TClass *TriBCM::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriBCM*)0x0)->GetClass(); }
   return fgIsA;
}
...
namespace ROOT {
   ...
   static void *new_TriBCM(void *p) {
      return  p ? new(p) ::TriBCM : new ::TriBCM;
   }
   static void *newArray_TriBCM(Long_t nElements, void *p) {
      return p ? new(p) ::TriBCM[nElements] : new ::TriBCM[nElements];
   }
...
"/home/shujie/analyzer/tritium-official/replay/libraries/TriBCM",
"/u/apps/root/6.12.06/root/include",
"/home/shujie/analyzer/tritium-official/replay/libraries/TriBCM/",
0
    };
