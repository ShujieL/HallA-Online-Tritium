...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::Tritium_Beam_Eloss*)0x0)->GetClass(); }
   return fgIsA;
}
...
"/home/shujie/analyzer/tritium-official/replay/libraries/Tritium_Beam_Eloss",
"/u/apps/root/6.12.06/root/include",
"/home/shujie/analyzer/tritium-official/replay/libraries/Tritium_Beam_Eloss/",
0
    };
