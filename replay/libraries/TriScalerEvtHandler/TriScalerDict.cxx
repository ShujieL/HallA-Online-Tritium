...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriScalerEvtHandler*)0x0)->GetClass(); }
   return fgIsA;
}
...
"/home/shujie/analyzer/tritium-official/replay/libraries/TriScalerEvtHandler",
"/u/apps/root/6.12.06/root/include",
"/home/shujie/analyzer/tritium-official/replay/libraries/TriScalerEvtHandler/",
0
    };
