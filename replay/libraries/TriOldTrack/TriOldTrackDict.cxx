...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriTrackInfo*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriTrackingModule*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriSpectrometer*)0x0)->GetClass(); }
   return fgIsA;
}
...
TClass *TriHRS::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriHRS*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriSpectrometerDetector*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriTrackingDetector*)0x0)->GetClass(); }
   return fgIsA;
}
...
TClass *TriVDC::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriVDC*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriVDCPlane*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriVDCUVPlane*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriVDCCluster*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriVDCWire*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriVDCHit*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriVDCTimeToDistConv*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriVDCUVTrack*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriVDCTrackPair*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriTrackID*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriVDCTrackID*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriTrack*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriNonTrackingDetector*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriScintillator*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriVDCAnalyticTTDConv*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriTriggerTime*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriTrackProj*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TriXscin*)0x0)->GetClass(); }
   return fgIsA;
}
...
"/home/shujie/analyzer/tritium-official/replay/libraries/TriOldTrack",
"/u/apps/root/6.12.06/root/include",
"/home/shujie/analyzer/tritium-official/replay/libraries/TriOldTrack/",
0
    };
