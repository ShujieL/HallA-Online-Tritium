...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::Tritium_TSScaler*)0x0)->GetClass(); }
   return fgIsA;
}
...
"/home/shujie/analyzer/tritium-official/replay/libraries/Tritium_TSScaler",
"./Tritium_Xscin",
